...
<!-- スクショを貼るには assets/secure-2-purview-dspm.png を置き、下行の <!-- と --＞ を外す -->
...
<!-- スクショを貼るには assets/secure-3-1-agents-at-risk.png を置き、下行の <!-- と --＞ を外す -->
...
<!-- スクショを貼るには assets/secure-3-2-defender-alerts.png を置き、下行の <!-- と --＞ を外す -->
