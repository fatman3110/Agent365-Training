# 第3部（ボーナストラック）：AI Teammate

第1～2部で作った **S2S エージェント**とは別軸として、**独自の M365 ID を持つ AI Teammate** を作る。**第1～2部の環境・リソースには一切変更を加えず、すべて新規追加**で進める。

> ⚠️ **新しい前提：AI Teammate は Frontier preview 限定**

> ⚠️ Microsoft Agent 365 / Frontier は Preview を多く含む。コマンド・API・提供リージョンは変わり得るので、Microsoft Learn で最新を確認すること。
